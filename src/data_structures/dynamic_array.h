...
/**
 * Pushes item to the top of the passed dynamic array.
 * 
 ...
 * 
 * However, if it is a variable length array (VLA) then it'll have to evaluate the element,
 * therefore dereferencing NULL. This is not an issue though, as our dynamic array isn't a VLA.
 */
#define PUSH_DA(da, item) \
    do { \
